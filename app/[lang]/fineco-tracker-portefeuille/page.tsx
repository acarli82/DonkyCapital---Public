...
const THIS_SLUG = 'fineco-tracker-portefeuille'
const CORRECT_LOCALE: Locale = 'fr'

export async function generateStaticParams() {
  // Only generate for French locale
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    lang,
    path: `/${THIS_SLUG}`,
    title: dict.seo.fineco?.title || 'Fineco Tracker Portefeuille | Importer Fineco vers DonkyCapital',
    description: dict.seo.fineco?.description || 'Suivez votre portefeuille Fineco avec DonkyCapital. Exportez vos transactions depuis Fineco Reports et importez-les dans notre tracker avancé.',
    alternateLanguages,
  })
}
