...
const THIS_SLUG = 'importer-les-donnees-degiro'
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    lang,
    path: `/${THIS_SLUG}`,
    title: dict.seo.degiro?.title || 'Importer les données Degiro | DonkyCapital',
    description: dict.seo.degiro?.description || 'Importez votre portefeuille de Degiro vers DonkyCapital',
    alternateLanguages,
  })
}
