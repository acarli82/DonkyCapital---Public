...
const THIS_SLUG = 'suivre-portefeuille-plusieurs-courtiers'
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    lang,
    path: `/${THIS_SLUG}`,
    title: dict.seo.multiBroker?.title || 'Portfolio Tracking Multi-Courtiers | DonkyCapital',
    description: dict.seo.multiBroker?.description || 'Suivez vos investissements sur plusieurs courtiers dans un tableau de bord unique',
    alternateLanguages,
  })
}
