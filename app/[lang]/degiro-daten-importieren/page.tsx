...
const THIS_SLUG = 'degiro-daten-importieren'
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    lang,
    path: `/${THIS_SLUG}`,
    title: dict.seo.degiro?.title || 'Import from Degiro | DonkyCapital',
    description: dict.seo.degiro?.description || 'Import your portfolio from Degiro to DonkyCapital',
    alternateLanguages,
  })
}
