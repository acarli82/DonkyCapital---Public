...
export default function MobileMenu({ dict, lang }: MobileMenuProps) {
  ...
  // Portal content - rendered directly in body to escape header's stacking context
  const menuPortal = mounted ? createPortal(
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-[280px] bg-[#0f151d] z-[9999] transform transition-transform duration-300 shadow-2xl ${
