  ...
  return (
    <div className="py-8">
      ...
      <div className="mb-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-6">
          {(degiro.pageTitle || 'Importare da Degiro').split('Degiro').map((part: string, index: number, array: string[]) => (
            <span key={index}>
              {index > 0 && <span className="gradient-text">Degiro</span>}
        ...
        <p
          ...
          dangerouslySetInnerHTML={{ __html: degiro.intro || 'Importa il tuo portafoglio da Degiro.' }}
        />
      </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">{degiro.whyExportTitle || 'Perché esportare da Degiro'}</h2>
        <div className="card p-6 space-y-4">
          <p
            className="text-white/80"
            dangerouslySetInnerHTML={{ __html: degiro.whyExportText2 || 'Esporta i tuoi dati in modo facile e veloce.' }}
          />
      ...
      <section className="mb-12">
        ...
        <div className="card p-6 space-y-4">
          <p
            className="text-white/80"
            dangerouslySetInnerHTML={{ __html: degiro.whyDonkyText1 || 'DonkyCapital offre una dashboard completa per il tuo portafoglio.' }}
          />
          <ul className="list-disc list-inside space-y-2 text-white/80">
          ...
          <p
            className="text-white/80"
            dangerouslySetInnerHTML={{ __html: degiro.whyDonkyText2 || 'Gestisci tutti i tuoi investimenti in un unico posto.' }}
          />
          <blockquote className="border-l-4 border-primary pl-4 py-2 text-white/90 italic bg-primary/5 rounded-r">
      ...
      {/* Step 1 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">{degiro.step1Title || 'Passo 1'}</h2>
        <div className="card p-6 space-y-4">
      ...
      {/* Step 2 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">{degiro.step2Title || 'Passo 2'}</h2>
        <div className="card p-6 space-y-4">
          <ol className="list-decimal list-inside space-y-2 text-white/80">
          ...
          <p className="text-white/80">{degiro.step2Text || 'Segui questi passaggi.'}</p>
          <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
      ...
      {/* Step 3 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">{degiro.step3Title || 'Passo 3'}</h2>
        <div className="card p-6">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-4">
              ...
              <p className="text-white/80">{degiro.step3Text || 'Ulteriori dettagli.'}</p>
              <ul className="list-disc list-inside space-y-2 text-white/80">
